/**
 * Upload visuel section Concept → site-assets/concept/cosy-kombucha-tournage.png
...
const filePath = path.join(root, 'public', 'images', 'concept-cosy-kombucha-tournage.png')
const storagePath = 'concept/cosy-kombucha-tournage.png'
...
if (error) {
  ...
  console.error('Utilisez SUPABASE_SERVICE_ROLE_KEY ou une politique INSERT autorisée pour ce chemin.')
  process.exit(1)
}

console.log('Visuel concept uploadé:', storagePath)
